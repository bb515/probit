...
from probit.EP import (
    training, EP_plotting, outer_loops, grid_synthetic, EP_training, grid,
    EP_testing
)
...
# def EP_testing(
#         dataset, Kernel, X_train, t_train, X_test, t_test, gamma, varphi,
#         noise_variance, scale, J, D, plot=True):
#     """
...
# def grid_synthetic(J, Kernel, X_train, t_train, domain_x1, domain_x2,
...
#         domain_x1, domain_x2, res, gamma_0=gamma, varphi_0=varphi, noise_variance_0=noise_variance, scale_0=scale)
#     if ylabel is None:
#         plt.plot(x, Z)
