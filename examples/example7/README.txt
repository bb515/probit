...
TODO: Implement the generalized linear model for a direct comparison.
	Code up the metropolis-within-gibbs step.
...
The data_septile.npz has the following dimensions
K = 7
x is on the real line, D=1
...
The data_tertile.npz has the following dimensions
K = 3
x is on the real line, D=1
y is the latent response variable on the real line
N = 1536 = K * 512
