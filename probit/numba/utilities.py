...
def compute_integrals_vector(
    ...
    #         gamma_t, gamma_tplus1,
    #         noise_std, EPS=EPS, EPS_2=EPS_2, N=N)
    # )
...
# # np.savez(
# #     "temp_data.npz", gamma=gamma, posterior_variance=posterior_variance,
# #     posterior_mean=posterior_mean, noise_variance=noise_variance,
# #     t_train=t_train)
...
# gamma = data["gamma"]
# posterior_variance = data["posterior_variance"]
