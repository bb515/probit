...
def read_all_datasets(path, list_of_writepaths, folds=20):
    ...
    for write_path in list_of_writepaths:
        ...
        X_10trains, t_10trains = read_partitioned_data(list_of_write_paths_10test)
        X_10tests, t_10tests = read_partitioned_data(list_of_write_paths_10train)
        # X_5trains, t_5trains = read_partitioned_data(list_of_write_paths_5test)
        # X_5tests, t_5tests = read_partitioned_data(list_of_write_paths_5train)
